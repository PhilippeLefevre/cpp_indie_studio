...
// Last update Wed Jun 14 11:37:19 2017 Philippe Lefevre
//
...
int	main(void)
{
        ...
        for (size_t x = 0; x < 15; x++)
        {
                for (size_t y = 0; y < 15; y++)
                {
                        ...
                        switch (_map[x][y])
                        {
                                ...
                                case indie::EntityType::BOMB_NORMAL: block.push_back(new indie::DestructibleBlock(_sceneManager, core::vector3df((x * 10.0f), -70.0f, (y * 10.0f)), _driver, false)); break;
        ...
        while(_device->run())
        {
                ...
                {
                        ((indie::ICharacter*)w)->Move(fps, block);
                }
